...
static class _UniFFILib
{
    ...
    [DllImport("snapxrust", CallingConvention = CallingConvention.Cdecl)]
    public static extern IntPtr ffi_snapxrust_rust_future_complete_pointer(
        IntPtr @handle,
        ref UniffiRustCallStatus _uniffi_out_err
    );
    ...
    static void uniffiCheckContractApiVersion()
    {
        ...
        if (29 != scaffolding_contract_version)
        {
            throw new UniffiContractVersionException(
                $"uniffi.snapxrust: uniffi bindings expected version `29`, library returned `{scaffolding_contract_version}`"
            );
        }
    }
